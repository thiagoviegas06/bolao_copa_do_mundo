...
export const MOCK_MATCHES: Match[] = [
  // Fase de grupos — finalizados
  {
    ...
    home_score: 2, away_score: 0, status: 'FINISHED', created_at: d(-10),
  },
  {
    ...
    home_score: 1, away_score: 1, status: 'FINISHED', created_at: d(-10),
  },
  {
    ...
    home_score: 3, away_score: 2, status: 'FINISHED', created_at: d(-10),
  },
  // Ao vivo
  {
    ...
    home_score: 1, away_score: 0, status: 'LIVE', created_at: d(-10),
  },
  // Agendados — fase de grupos
  {
    ...
    home_team_flag: '🇧🇷', away_team_flag: '🇦🇷',
    match_date: d(1), stage: 'Fase de Grupos',
    home_score: null, away_score: null, status: 'SCHEDULED', created_at: d(-10),
  },
  {
